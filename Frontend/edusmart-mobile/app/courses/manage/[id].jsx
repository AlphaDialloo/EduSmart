...
export default function ManageCoursePage() {
  ...
  async function removeModule(moduleId) {
    Alert.alert(
      "Supprimer le module",
      "Les ressources de ce module seront également supprimées.",
      [
  ...
  async function createResource() {
    ...
    if (
      ...
      resourceForm.articleContent.trim().length < 5
    ) {
    ...
    if (
      ...
      !resourceForm.videoAssetId.trim()
    ) {
    ...
    try {
      ...
      await addCourseResource(
        ...
        resourceModuleId,
        {
          ...
          description:
            resourceForm.description.trim() || null,
    ...
    <>
      ...
      >
        ...
        <Section title="Niveau du cours">
          ...
          <Pressable
            onPress={saveLevel}
            disabled={busy || level === course?.level}
            style={{
              marginTop: 13,
              minHeight: 47,
              alignItems: "center",
        ...
        <Section title="Publication">
          ...
          {course?.status === "PUBLISHED" ? (
            <Pressable
              onPress={() => changeStatus("unpublish")}
              disabled={busy}
              style={{
                marginTop: 14,
                minHeight: 49,
      ...
      <Modal
        ...
        transparent
        animationType="slide"
        onRequestClose={() => setModuleModal(false)}
      >
        <View
          style={{
            flex: 1,
      ...
      <Modal
        ...
        transparent
        animationType="slide"
        onRequestClose={() => setResourceModal(false)}
      >
        <View
          style={{
            flex: 1,
        ...
        >
          ...
          >
            ...
            {resourceForm.type === "VIDEO" ? (
              <Input
                label="Video Asset ID ou URL"
                value={resourceForm.videoAssetId}
                onChangeText={(value) =>
                  setResourceForm((current) => ({
                    ...current,
                    videoAssetId: value,
