...
export default function AdminUsersPage() {
  ...
  const loadUsers = useCallback(async () => {
    ...
    try {
      ...
      console.log(
        "[AdminUsersPage] Réponse API :",
        data,
      );

      const receivedUsers = Array.isArray(data?.users)
        ? data.users
      ...
      setPagination({
        ...
        totalPages:
          ...
          (receivedUsers.length > 0 ? 1 : 0),
      });
    } catch (requestError) {
      console.error(
        "[AdminUsersPage] Erreur :",
  ...
  async function toggleUser(user) {
    ...
    if (!id) {
      setError(
        "L’identifiant de cet utilisateur est absent.",
      );
      return;
    }
      ...
      <section className="mt-8 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row">
          ...
          <select
            ...
            className="rounded-2xl border border-slate-200 bg-white px-4 py-3.5 font-bold text-slate-700"
          >
            <option value="ALL">
              Tous les rôles
            </option>
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        <select
                          ...
                          className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-black text-slate-700 disabled:opacity-60"
                        >
                          <option value="STUDENT">
                            Étudiant
                          </option>
                      ...
                      <td className="px-5 py-4 text-right">
                        <button
                          ...
                          className={`inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-black disabled:cursor-not-allowed disabled:opacity-60 ${
                            user.isActive === false
