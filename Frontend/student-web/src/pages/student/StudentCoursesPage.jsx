  ...
  useEffect(() => {
    ...
    async function loadCourses() {
      try {
        ...
        console.error(
          "Erreur chargement des cours étudiant :",
          requestError,
        );
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
          ...
          <div className="mt-3 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            ...
            <div className="flex w-full max-w-md items-center rounded-2xl border border-slate-200 bg-slate-50 px-4 focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-100 lg:w-auto">
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between gap-3">
                      <span className="truncate text-xs font-black uppercase tracking-wide text-indigo-600">
                    ...
                    <Link
                      ...
                      state={{ enrollmentId }}
                    >
                      <h2 className="mt-3 line-clamp-2 min-h-14 text-xl font-black text-slate-950 transition hover:text-indigo-600">
                        {course.title}
                      </h2>
                    </Link>
                    ...
                    <Link
                      to={`/student/courses/${course.id}`}
                      state={{ enrollmentId }}
                      className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-5 py-3.5 font-black text-white transition hover:bg-indigo-700"
                    >
                      <PlayCircle size={19} />
                      {status === "COMPLETED"
                        ? "Revoir le cours"
