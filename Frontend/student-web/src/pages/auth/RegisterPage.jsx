...
function RegisterPage() {
  ...
  return (
    <main className="grid min-h-screen bg-[#f7f8fc] lg:grid-cols-2">
      <section className="hidden bg-slate-950 p-12 text-white lg:flex lg:flex-col lg:justify-between">
        <Link
          to="/"
          className="inline-flex items-center gap-3"
        >
          <div className="flex size-12 items-center justify-center rounded-2xl bg-indigo-600">
            <BookOpen size={24} />
          </div>
          ...
          >
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                ...
                <div className="mt-2 flex items-center rounded-2xl border border-slate-200 bg-white px-4 focus-within:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-100">
                  <UserRound
                    size={19}
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex w-full items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-6 py-4 font-black text-white shadow-lg shadow-indigo-200 transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {submitting && (
                <LoaderCircle
                  size={19}
