...
function CourseDetailPage() {
  ...
  const activePlans = useMemo(() => {
    ...
    return course.pricing.accessPlans
  ...
  const handleAddToCart = () => {
    ...
    setCartMessage(
      `${selectedPlan.planType} ajouté au panier.`,
    );
      ...
      <section className="bg-slate-950 text-white">
        <div className="mx-auto max-w-7xl px-5 py-10 lg:px-8 lg:py-14">
          ...
          <div className="mt-8 grid items-center gap-10 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
              <span className="inline-flex rounded-full bg-indigo-500/20 px-4 py-2 text-sm font-bold text-indigo-200">
              ...
              <div className="mt-7">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {course.tags.map((tag) => (
                    <span
                      key={tag}
                      className="rounded-full bg-indigo-50 px-3 py-1.5 text-sm font-bold text-indigo-700"
                    >
                      {tag}
                    </span>
                  ))}
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-200/60">
            ...
            {!course.isFree && (
              <button
                ...
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-6 py-4 font-black text-white shadow-lg shadow-indigo-200 transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            {cartMessage && (
              <div className="mt-4 rounded-xl bg-emerald-50 px-4 py-3 text-center text-sm font-bold text-emerald-700">
                {cartMessage}
              </div>
            )}
