...
function CoursesPage() {
  ...
  return (
    <main className="mx-auto min-h-[70vh] max-w-7xl px-5 py-12 lg:px-8">
      <div className="max-w-3xl">
        <p className="font-bold uppercase tracking-wider text-indigo-600">
          Catalogue EduSmart
        </p>
      ...
      <form
        ...
        className="mt-8 flex flex-col gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:flex-row"
      >
        ...
        <>
          ...
          <div className="mt-10 flex items-center justify-center gap-4">
            <button
              ...
              className="rounded-xl border border-slate-300 px-5 py-2.5 font-bold text-slate-700 disabled:cursor-not-allowed disabled:opacity-40"
            >
              Précédent
            </button>
