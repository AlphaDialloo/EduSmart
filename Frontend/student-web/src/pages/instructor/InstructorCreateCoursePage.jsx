...
function InstructorCreateCoursePage() {
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      navigate(courseId ? `/instructor/courses/${courseId}` : "/instructor/courses", { replace: true });
    } catch (requestError) {
      setError(
      ...
      <main className="min-h-screen bg-[#f7f8fc]">
        <div className="mx-auto max-w-5xl px-5 py-10 lg:px-8">
          <Link
            ...
            className="inline-flex items-center gap-2 text-sm font-black text-indigo-600"
          >
          ...
          <form onSubmit={submit} className="mt-8 space-y-7">
              ...
              <div className="mt-6 grid gap-5 sm:grid-cols-2">
                <label className="sm:col-span-2 text-sm font-bold text-slate-700">
                  ...
                  <input
                    ...
                    value={form.title}
                    onChange={change}
                    className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3.5 outline-none focus:border-indigo-500"
                  />
                </label>
                ...
                <label className="text-sm font-bold text-slate-700">
                  ...
                  <select
                    ...
                    className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3.5"
                  >
              ...
              <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <label className="text-sm font-bold text-slate-700">
                  ...
                  <input
                    ...
                    onChange={change}
                    className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3.5 uppercase"
                  />
                </label>
                {!form.isFree && (
                  <>
            ...
            <button
              type="submit"
              disabled={saving}
              className="flex w-full items-center justify-center gap-2 rounded-2xl bg-indigo-600 px-6 py-4 font-black text-white disabled:opacity-60"
            >
