    ...
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-18 max-w-7xl items-center justify-between gap-5 px-5 lg:px-8">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link
            to="/cart"
            aria-label={`Ouvrir le panier, ${itemCount} article${
              itemCount > 1 ? "s" : ""
            }`}
            className="relative flex size-11 items-center justify-center rounded-xl text-slate-600 transition hover:bg-indigo-50 hover:text-indigo-600"
          >
          ...
          {!isAuthenticated ? (
            <>
              ...
              <Link
                to="/register"
                className="hidden rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-indigo-200 transition hover:bg-indigo-700 sm:block"
              >
                S’inscrire
              </Link>
            </>
            ...
            >
              ...
              >
                <span className="flex size-10 items-center justify-center rounded-xl bg-indigo-100 text-sm font-black text-indigo-700">
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-3 w-64 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-300/50">
                  ...
                  <div className="p-2">
                    <Link
                      ...
                      className="flex items-center gap-3 rounded-xl px-3 py-3 text-sm font-bold text-slate-700 transition hover:bg-indigo-50 hover:text-indigo-700"
                    >
          ...
          <button
            ...
            className="flex size-11 items-center justify-center rounded-xl text-slate-700 transition hover:bg-slate-100 lg:hidden"
          >
            <Menu size={22} />
          </button>
        </div>
