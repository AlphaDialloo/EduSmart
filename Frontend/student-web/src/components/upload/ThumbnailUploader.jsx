...
export default function ThumbnailUploader({
  ...
  return <div className="space-y-4">
      ...
      {value?.url ? <div className="overflow-hidden rounded-2xl border">

          <img src={value.url} alt="" className="h-56 w-full object-cover" />

        </div> : <button type="button" onClick={() => inputRef.current.click()} className="flex h-56 w-full flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 hover:border-emerald-500">
          <ImagePlus size={40} />
      ...
      {uploading && <div className="flex items-center gap-3 text-emerald-600">
