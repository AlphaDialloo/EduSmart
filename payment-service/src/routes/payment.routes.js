...
router.get("/admin/summary", authenticate, authorize("ADMIN", "SUPER_ADMIN"), c.adminSummary);
router.get("/admin", authenticate, authorize("ADMIN", "SUPER_ADMIN"), c.adminList);
router.get("/instructor/analytics", authenticate, authorize("INSTRUCTOR", "ADMIN", "SUPER_ADMIN"), c.instructorAnalytics);
router.get("/admin/:id", authenticate, authorize("ADMIN", "SUPER_ADMIN"), c.adminGetOne);
router.post("/admin/:id/refund", authenticate, authorize("ADMIN", "SUPER_ADMIN"), c.refund);
