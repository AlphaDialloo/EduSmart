  ...
  app.use(
    ...
    createProxyMiddleware({
      ...
      on: {
        ...
        error(error, req, res) {
          console.error(
            `[Gateway] Erreur proxy ${req.method} ${req.originalUrl} :`,
            error.message,
          );
...
/*
 * Les routes utilisateurs Admin sont actuellement
 * hébergées dans auth-service.
 */
proxy("/api/users", process.env.AUTH_SERVICE_URL);
